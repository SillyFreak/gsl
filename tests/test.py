...
class TestGenerate(unittest.TestCase):
    ...
    def test_generate(self):
        ...
        def code():
            yield from lines("""\
generated header
# <default GSL customizable: section1 />
generated divider
# <default GSL customizable: section2>
# </GSL customizable: section2>
generated footer
""")
